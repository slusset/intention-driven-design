    ...
    if (Array.isArray(step.actions)) {
      for (const action of step.actions) {
        ...
        applyKindedCheck({
          ...
          validKindsHint: 'ui-interaction, navigation, wait, network, cli, install, mcp, harness',
          errors,
          warnings,
          info,
        });
    ...
    if (Array.isArray(step.assertions)) {
      for (const assertion of step.assertions) {
        ...
        applyKindedCheck({
          ...
          validKindsHint: 'dom, url, api, cookie, classification, tag, context, lifecycle, authority, content, package',
          errors,
          warnings,
          info,
        });
